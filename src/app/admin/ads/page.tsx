    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {analytics && [
          ...
          <motion.div
            key={typeof stat.title === 'object' ? stat.title.translatedText : stat.title}
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">{typeof stat.title === 'object' ? stat.title.translatedText : stat.title}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
              ...
              {topPerformingAds.translatedText}
            </h3>
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <h1 className="text-2xl font-bold text-gray-900">{dashboardTitle.translatedText}</h1>
